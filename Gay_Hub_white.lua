...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://94678517792779",
...
gz.Image = "rbxassetid://94678517792779";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">nyann os</font> " .. dz.TitleNameNoti));
		...
		I.Image = "rbxassetid://94678517792779";
...
function Kz.CreateMain(Y)
	...
	r.Image = "rbxassetid://94678517792779";
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">nyann os</font> : Blox Fruits");
	...
	y.Image = "rbxassetid://94678517792779";
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://94678517792779";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">nyann os</font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
	...
	L.Image = "rbxassetid://94678517792779";
	...
	function V.T(Y)
		...
		function S.CreateSection(Y, d, R, r)
			...
			if a then
				...
				Q.ZIndex = 2;
				Q.Image = "rbxassetid://94678517792779";
			...
			function i.CreateToggle(Y, d)
				...
				K.Image = "rbxassetid://94678517792779";
			...
			function i.CreateButton(Y, d)
				...
				g.Image = "rbxassetid://94678517792779";
			...
			function i.CreateDropdown(Y, d)
				...
				z.Image = "rbxassetid://94678517792779";
					...
					elseif F then
						...
						for Y, d in W(L) do
							if typeof(d) == "string" then
								...
								M.ZIndex = 2;
								M.Image = "rbxassetid://94678517792779";
...
oq.CreateButton({ Title = "Rain Fruits (Client)", Callback = function()
		for Y, R in pairs((game:GetObjects("rbxassetid://94678517792779"))[1]:GetChildren()) do
