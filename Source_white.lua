...
local Library do
    ...
    local Themes = {
        ["Default"] = {
            ...
            ["Light Accent"] = FromRGB(220, 220, 220),
    ...
    local Items = { } do
        ...
        Instances:Create("UIGradient", {
            ...
            Color = RGBSequence{RGBSequenceKeypoint(0, FromRGB(255, 0, 0)), RGBSequenceKeypoint(0.17, FromRGB(255, 255, 255)), RGBSequenceKeypoint(0.33, FromRGB(0, 255, 0)), RGBSequenceKeypoint(0.5, FromRGB(0, 255, 255)), RGBSequenceKeypoint(0.67, FromRGB(0, 0, 255)), RGBSequenceKeypoint(0.83, FromRGB(255, 0, 255)), RGBSequenceKeypoint(1, FromRGB(255, 0, 0))}
        }) 
