...
local redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/id202azh/nyannos/refs/heads/main/raw_black_white.txt"))()
...
local function ApplyGlobalFont(fontEnum)
    ...
    -- CoreGui / executor UI, where accessible
    pcall(function()
...
-- Tự áp dụng font cho Text objects được tạo sau này.
pcall(function()
    if LocalPlayer then
        local playerGui = LocalPlayer:FindFirstChildOfClass("PlayerGui")
        if playerGui then
...
Discord:AddProfile({
    Name = "nyann os",             
    Bio = "Ngày update:17-8-2026", 
    Avatar = "rbxassetid://94678517792779", 
    Cover = "rbxassetid://94678517792779", 
    Verified = true 
})
...
Discord:AddParagraph({
    "Thông báo",
    "Script đã update sau | Thời gian update:18-8-2026,Nếu có lỗi gì thì nhắn qua các trang mạng xã hội của tôi!"
})
