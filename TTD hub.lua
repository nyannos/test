...
local Window = Fluent:CreateWindow({Title = "TTD hub",SubTitle = "| Blox Fruit",TabWidth = 155,Size = UDim2.fromOffset(650, 400),Acrylic = false,Theme = "Light",MinimizeKey = Enum.KeyCode.End})
