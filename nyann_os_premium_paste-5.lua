...
-- ===================== TABS =====================
local TabMain = Window:MakeTab({"Information", "info"})
local TabBF = Window:MakeTab({"Blox fruit", "swords"})
local TabGag2 = Window:MakeTab({"Gag2", "sprout"})
local Tab5 = Window:MakeTab({"Script Fix lag", "zap"})
local Tab9 = Window:MakeTab({"Script Sailor piece", "anchor"})
local Tab10 = Window:MakeTab({"Script meme sea", "waves"})
local Tab11 = Window:MakeTab({"Script Dead rails", "train"})
local Tab12 = Window:MakeTab({"Script 99 night", "moon"})
local Tab13 = Window:MakeTab({"Script king legacy", "crown"})
local Tab14 = Window:MakeTab({"Script grow a garden", "flower-2"})
local Tab15 = Window:MakeTab({"Script blue lock", "goal"})
local Tab16 = Window:MakeTab({"Script the forge", "hammer"})
local Tab17 = Window:MakeTab({"Script rivals", "crosshair"})
local TabMisc = Window:MakeTab({"Setting", "settings"})
