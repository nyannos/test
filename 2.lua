...
local Tabs = {
    ...
    Esp = Window:MakeTab({ Title = "Chỉ số thống kê và hiển thị", Icon = "rbxassetid://7040410130" }),
    ...
    Shop = Window:MakeTab({ Title = "Cửa hàng", Icon = "rbxassetid://6031265976" }),
...
local TimeZone = Tabs.Info:AddParagraph("Thời gian", "")
...
local GameTime = Tabs.Info:AddParagraph("Thời gian trò chơi", "")
...
local FrozenCheck = Tabs.Info:AddParagraph("Kích thước đông lạnh", "Trạng thái: ")
...
local DoughKingCheck = Tabs.Info:AddParagraph("Bột đế vuiy", "Trạng thái: ")
...
local LegendarySwordCheck = Tabs.Info:AddParagraph("Kiếm huyền thoại", "Trạng thái: ")
...
Name = "Tự động nhặt Berry + Chuyển đổi máy chủ", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AutoBerryH = Value
...
Tabs.Main:AddSection("Đánh ở tất cả đảo")
...
Tabs.Main:AddToggle({
    Name = "Đánh tất quái ở đảo đã chọn",
    Default = false,
    Callback = function(Value)
...
local Process = Tabs.Main:AddParagraph("Quy trình ưu tú", "")
spawn(function()
    while wait(Sec) do
        pcall(function()    
...
local EliteHunter = Tabs.Main:AddParagraph("Trạng thái elite", "Trạng: ")
spawn(function()
...
EliteH = Tabs.Main:AddToggle({
	Name = "Đánh Elite + Chuyển đổi máy chủ",
	Description = "",
	Default = false,
	Callback = function(Value)
	_G.FarmEliteH = Value
...
Tabs.Main:AddSection("Trùm đột kích")

Tabs.Main:AddToggle({
Name = "Đánh trùm đột kích", 
Description = "", 
Default = false,
Callback = function(Value)
...
local MobKilled = Tabs.Main:AddParagraph("Số lượng quái đã đánh", "")
spawn(function()
    while wait(0.2) do
        pcall(function()
...
Tabs.Main:AddToggle({
    Name = "Đánh tư lệch bột + Chuyển đổi máy chủ",
    Default = false,
    Callback = function(Value)
...
local CheckingBone = Tabs.Main:AddParagraph("Xương", "")
spawn(function()
    while wait(0.2) do
        pcall(function()
...
local TyrantStatus = Tabs.Main:AddParagraph("Bạo chúa bầu trời", "")
spawn(function()
    pcall(function()
        while wait(1) do
...
local EyeStatus = Tabs.Main:AddParagraph("Trạng thái", "")
...
Tabs.Settings:AddSlider({
    Name = "Tốc độ chuyển đổi máy chủ",
    Min = 5,
    Max = 120,
    Default = 30,
    Increment = 1,
...
Name = "Xóa hoạt ảnh khi chết và hồi sinh", 
Description = "", 
Default = false,
Callback = function(Value)
  RDeath = Value
...
Tabs.Settings:AddToggle({
    Name = "Tự chống lại quản trị viên tham gia máy chủ",
    Description = "",
    Default = true,
    Callback = function(Value)
...
Name = "Tự động chấp nhận nhiệm vụ câu cá", 
Description = "",
Default = false,
Callback = function(Value)
...
Name = "Tự động làm nhiệm vị biển thứ ba", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AutoZou = Value
...
Tabs.Quests:AddSection("Kiếm Tushita và Yama")
...
Tabs.Quests:AddSection("Đàn linh hồn / Linh tinh")
local CheckSoul = Tabs.Quests:AddParagraph("Nhiệm vụ Đàn linh hồn", "")
spawn(function()
    while wait(0.2) do
        pcall(function()
            if Quest1 == true then 
...
Tabs.Quests:AddToggle({
Name = "Tự động cày nguyên liệu lấy đàn linh hồn", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Quests:AddSection("Sống đao nguyền rủa")
local CheckCDK = Tabs.Quests:AddParagraph("Số nhiệm vụ song kiếm katana bị nguyền rủa", "Số nhiệm vụ :")
spawn(function()  
    while wait(0.2) do 
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy song đao nguyền rủa [ Nhiệm vụ cuối cùng ]", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.CDK = Value
...
Tabs.Quests:AddSection("Lôi gậy")
Q = Tabs.Quests:AddToggle({
Name = "Lấy Lôi gậy thể một", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AutoPole = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Lấy Lôi gậy thể hai [Thử nghiệm]", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AutoPoleV2 = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy áo choàng gái đen", 
Description = "", 
Default = false,
Callback = function(Value)
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động mở khoá cửa Donswan", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Quests:AddSection("Kiếm Cavender + Song móc + Mẹ lớn")
Q = Tabs.Quests:AddToggle({
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động lấy kiếm Canvendish", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Quests:AddSection("Màu sắc haki")
Q = Tabs.Quests:AddToggle({
Name = "Tự động bay đến Barista Cousin", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Tp_MasterA = Value
...
Q = Tabs.Quests:AddToggle({
Name = "Tự động làm nhiệm vụ haki bảy màu nhanh hơn", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.GetQFast = Value
...
Tabs.Quests:AddSection("Quan sát")
Q = Tabs.Quests:AddToggle({
...
Tabs.Quests:AddSection("Phong cách chiến đấu / Võ")
...
Name = "Tự động lấy Huyết quỷ thuật", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Snaguine = Value
...
Tabs.Race:AddSection("Đảo bí ẩn / Trăng tròn")
local FullMOOn = Tabs.Race:AddParagraph("Trạng thái Trăng tròn", "")
local Ismirage = Tabs.Race:AddParagraph("Trạng thái Đảo bí ẩn", "")
spawn(function()
    while wait(0.2) do
...
Tabs.Race:AddToggle({
Name = "Tự động bay đến Đảo bí ẩn", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.FindMirage = Value
...
Tabs.Race:AddToggle({
    Name = "Hiệu ứng chuyển cảnh tự động đến Đảo Ảo Ảnh",
    Description = "",
    Default = false,
    Callback = function(Value)
...
Tabs.Race:AddToggle({
Name = "Tự động bay đến điểm cao nhất trên Đảo bí ẩn", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Race:AddToggle({
Name = "Change Transparent có thể thấy", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.can = Value
...
Tabs.Race:AddToggle({
Name = "Bay đến người bán trái đặc biệt", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Addealer = Value
...
Tabs.Race:AddSection("Nhiệm vụ thử nghiệm tộc V4")
local CheckTier = Tabs.Race:AddParagraph("Trạng thái Nhiệm vụ thử nghiệm tộc V4", "")
spawn(function()
    pcall(function()
        while wait(0.2) do
            CheckTier:SetDesc("Nhiệm vụ thử nghiệmtộc V4 : " .. " " .. plr.Data.Race.C.Value)
        end
    end)
end)
...
Name = "Tự động hoàn thành trial V4", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.AcientOne = Value
...
Name = "Tự động tiêu diệt người chơi trong trial", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Defeating = Value
...
Name = "Tự động hoàn thành Dojo Trainer", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Dojoo = Value
...
Tabs.Prehistoric:AddSection("Thử nghiệm Dragon")
...
Toggle = Tabs.Prehistoric:AddToggle({
Name = "Thử nghiệm Auto Relic Drago [Thử nghiệm]", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.Relic123 = Value
...
Toggle = Tabs.Prehistoric:AddToggle({
Name = "Tự động hoàn thành Drago v4", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.TrainDrago = Value
...
Name = "Nâng cấp tộc Rồng cùng Uzoth", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.DT_Uzoth = Value
...
Tabs.Prehistoric:AddSection(" Lắp ráp Volcanic")

Tabs.Prehistoric:AddButton({
Name = "Lắp ráp Dragonheart", 
Description = "",
Callback = function()
        local args = {
            [1] = "CraftItem",
...
local Check_Volcano = Tabs.Prehistoric:AddParagraph("Trạng thái Đảo tiền sử", "")
spawn(function()
    while wait(0.2) do
        if workspace.Map:FindFirstChild("PrehistoricIsland") or workspace._WorldOrigin.Locations:FindFirstChild("Prehistoric Island") then
...
Tabs.Prehistoric:AddToggle({
    Name = "Tự động bắt đầu sự kiện ở Đảo tiền sử",
    Default = false,
    Callback = function(Value)
...
Toggle = Tabs.Prehistoric:AddToggle({
Name = "Tự động đặt lại nhân vật khi hoàn thành Đảo tiền sử", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.ResetPH = Value
...
Tabs.SeaEvent:AddSection("Sự kiện biển / Cài đặt tàu")
...
Tabs.SeaEvent:AddSection("Lắp ráp vật phẩm")


Tabs.SeaEvent:AddButton({
Name = "Lắp ráp SharkTooth", 
Description = "",
Callback = function()
        local args = {
            [1] = "CraftItem",
...
Tabs.SeaEvent:AddSection("Đánh các sự kiện biển")
...
Tabs.SeaEvent:AddToggle({
Name = "Đánh Attack PirateGrandBrigade", 
Description = "", 
Default = false,
Callback = function(Value)
  _G.PGB = Value
...
Tabs.SeaEvent:AddSection("Đảo cáo quỷ / Sự kiện")
local Check_Kitsu = Tabs.SeaEvent:AddParagraph("Trạng thái Đảo cáo quỷ", "")
spawn(function()
    while wait(0.2) do
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động bay đến Đảo cáo quỷ", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động bay đến Shrine Actived", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.SeaEvent:AddButton({
Name = "Nói chuyện với kitsune statue", 
Description = "",
Callback = function()
  replicated.Modules.Net:FindFirstChild("RE/TouchKitsuneStatue"):FireServer()
end})
...
local FloD = Tabs.SeaEvent:AddParagraph("Trạng thái FrozenDimension", "")
spawn(function()
    pcall(function()
        while wait(0.2) do
...
local SPYING = Tabs.SeaEvent:AddParagraph("Trạng thái Spy", "")
spawn(function()
    while wait(0.2) do
        pcall(function()
...
Tabs.SeaEvent:AddToggle({
Name = "Tự động kéo tìm về Hydra Island", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Raids:AddSection("Bảng trái")
...
local function getFruitStock()
    local resultStr = "Bán trái đặc biệt\n"
...
Name = "Tự động quay ngẫu nhiên trái", 
Description = "", 
Default = false,
Callback = function(Value)
...
Tabs.Raids:AddSection("Đột kích Dungeon / Đột kích")
...
Tabs.Raids:AddToggle({
    Name = "Lấy trái dưới 1M trong kho",
    Default = false,
    Callback = function(Value)
...
Raiding = Tabs.Raids:AddToggle({
    Name = "Bắt đầu đột kích + Sang đảo khác",
    Description = "",
    Default = false,
    Callback = function(Value)
        _G.Raiding = Value
...
Tabs.Raids:AddToggle({
    Name = "Tự động bay đến phòng thí nghiệm",
    Default = false,
    Callback = function(Value)
        _G.TpLab = Value
        StopTween(_G.TpLab)
...
Tabs.Raids:AddSection("Vật phẩm Law / Kiếm Order")
