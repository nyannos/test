...
local function startBring()
    ...
    bringConnection = task.spawn(function()
...
-- Nếu menu hiện tại của file có toggle Bring, thay callback của toggle bằng:
-- startBring() khi bật và stopBring() khi tắt.
