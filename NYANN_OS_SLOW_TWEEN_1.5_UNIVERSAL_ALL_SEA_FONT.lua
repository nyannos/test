...
-- Universal Sea detection: these flags are defined before any feature code uses them.
...
do -- Universal Sea UI: always show
    v6:AddSection({"Universal Sea Events - all options visible"})
end
do -- Universal Sea UI: always show
    v6:AddSection({"Sea Event Controls - all options visible"})
end
    v6:AddToggle({
        Name = "Auto Shark",
        Default = false,
