...
-- chữ BETA màu xanh dương
task.defer(function()
  task.wait(0.15)
  pcall(function()
    local roots = {}
    if RealWindow and RealWindow.gui then table.insert(roots, RealWindow.gui) end
    pcall(function()
    ...
    for _, root in ipairs(roots) do
      for _, d in ipairs(root:GetDescendants()) do
        if (d:IsA("TextLabel") or d:IsA("TextButton")) and type(d.Text) == "string" then
          if d.Text == "BETA" or d.Text:find("%[BETA%]") or d.Text:lower() == "beta" then
            d.TextColor3 = blue
          end
        end
      end
...
task.spawn(function()
  ...
  local notif2 = Alurt.CreateNode({
    ...
    BarColor = Color3.fromRGB(0, 140, 255), -- blue
  })
end)
