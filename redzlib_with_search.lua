...
-- ... (Code phía dưới giữ nguyên)
	...
	-- Filter function: ẩn/hiện Option theo từ khóa
			...
			if cont and cont.Parent then
				for _, child in pairs(cont:GetChildren()) do
					if child:IsA("Frame") or child:IsA("TextButton") then
						...
						-- Tìm text label bên trong để match tên feature
						local labelText = ""
						...
						local matchStr = name .. labelText
						if query == "" or string.find(matchStr, query, 1, true) then
							child.Visible = true
						else
							child.Visible = false
						end
